package se.exuvo.aurora.ui.keys

import com.badlogic.gdx.Input
import com.badlogic.gdx.InputProcessor
import org.apache.logging.log4j.LogManager
import se.exuvo.aurora.ui.GalaxyScreen
...
//								println("Key $processorName, $enumName, $type, action $action, key $key")
								...
								val enumClass = Class.forName("se.exuvo.aurora.ui.keys." + enumName)
...
//								println(" Parsed $inputProcessor, $enumClass, $keyType, $enum")
	...
	init {
		keyActions[StarSystemScreen::class] = KeyActions_StarSystemScreen.values()
		keyActions[UIScreen::class] = KeyActions_UIScreen.values()
...
enum class KeyActions_UIScreen(override val defaultKey: Int? = null,
...
enum class KeyActions_StarSystemScreen(override val defaultKey: Int? = null,
                                            override val defaultType: KeyPressType
) : KeyAction {
	SPEED_UP('+'),
	SPEED_DOWN('-'),
