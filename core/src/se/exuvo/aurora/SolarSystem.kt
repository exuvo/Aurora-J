...
class SolarSystem {
	...
	fun init() {
		...
		entity1.add(engine.createComponent(PositionComponent::class.java).apply { x = 0; y = 0 })
...
//		entity1.add(engine.createComponent(LineComponent::class.java).apply { x = 100f; y = 100f })
		...
		entity4.add(engine.createComponent(CircleComponent::class.java).apply{ radius = 500f})
