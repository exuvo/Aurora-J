 ...
 * different agents the interface does not dictate how you should update the memory from the sensor - in a unity game probably you will want
 * to update the memory in the sensor's Update/FixedUpdate
 */
