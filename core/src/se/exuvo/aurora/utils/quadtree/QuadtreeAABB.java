...
public class QuadtreeAABB {
	...
	public static final int elt_idx_lft = 0, elt_idx_top = 1, elt_idx_rgt = 2, elt_idx_btm = 3;
	
	// Stores the ID of the element.
	public static final int elt_idx_id = 4;
	
	// Stores all the elements in the quadtree.
	public final IntList elts = new IntList(5, 128);
	...
	public static final int enode_idx_elementIdx = 1;
	...
	public static final int node_idx_size = 1;
...
//	}
	...
	public void copy(@NotNull QuadtreeAABB tree) {
		elts.copy(tree.elts);
