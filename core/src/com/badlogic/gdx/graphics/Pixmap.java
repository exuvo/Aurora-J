...
public class Pixmap implements Disposable {
	 ...
	 * @author mzechner */
	public enum Format {
		Alpha, Intensity, LuminanceAlpha, RGB565, RGBA4444, RGB888, RGBA8888, RGBA16;
		...
		public static int toGdx2DPixmapFormat (Format format) {
			...
			if (format == RGBA16) return Gdx2DPixmap.GDX2D_FORMAT_RGBA16F;
		...
		public static Format fromGdx2DPixmapFormat (int format) {
			...
			if (format == Gdx2DPixmap.GDX2D_FORMAT_RGBA16F) return RGBA16;
