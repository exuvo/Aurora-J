...
class CustomLwjglGlfw(window: GlfwWindow, installCallbacks: Boolean = true, clientApi_: GlfwClientApi = GlfwClientApi.OpenGL, vrTexSize: Vec2i? = null) {

    var window: GlfwWindow
    val implGl3 = CustomImplGL3()
    var time = 0.0
